import { Color } from 'dominant-palette-kmeans';
...
export default function Home() {
    ...
    const extractColors = useCallback(async () => {
      ...
      const { get_dominant_colors } = await import('dominant-palette-kmeans');

      get_dominant_colors(imageData.bytes, 2, 10, 20).then((pal) => {
